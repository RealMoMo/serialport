 ...
 * 打开mic mute
 */
public class SerialPortMicMuteOn extends SerialPortModel {

    public static final String CONTROLLING_CODE = "7F 08 99 A2 B3 C4 02 FF 01 8D CF";
    //
    //XX=01 Set mute on success
    //XX=00 Set mute on failed
    protected String returnCode = "7F 08 99 A2 B3 C4 02 FF 01 8D XX CF";
