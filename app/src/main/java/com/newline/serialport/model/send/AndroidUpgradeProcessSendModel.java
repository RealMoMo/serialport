 ...
 * @time 2020/9/2 16:16
 * @describe Android升级过程发送数据包
 */
public class AndroidUpgradeProcessSendModel extends SendSerialPortModel {
    ...
    public AndroidUpgradeProcessSendModel(SerialPortUtils serialPort, boolean type) {
        super(serialPort);
        this.type = type;
    }
