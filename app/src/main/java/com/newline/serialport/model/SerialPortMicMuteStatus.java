 ...
 *
 */
public class SerialPortMicMuteStatus extends SerialPortModel {

    public static final String CONTROLLING_CODE = "7F 08 99 A2 B3 C4 02 FF 01 8F CF";

    protected String returnCode = "7F 08 99 A2 B3 C4 02 FF 01 8F XX CF";
    //  XX:
    //01  mute
    //00  unmute
