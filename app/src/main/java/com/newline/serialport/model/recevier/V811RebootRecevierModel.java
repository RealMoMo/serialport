 ...
 * @describe
 */
public class V811RebootRecevierModel extends RecevierSerialPortModel {

    public static final String CONTROLLING_CODE = "7F 08 99 A2 B3 C4 02 FF 3C 03 CF";
    private Context mContext;

    public V811RebootRecevierModel(HHTDeviceManager hhtDeviceManager, Context context) {
    ...
    @Override
    public void action() {
        NewlineDeviceUtils.sendRebootMsg(mContext);
    }
