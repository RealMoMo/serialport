 ...
 * @describe
 */
public class Number0SendModel extends BaseKeyEventSendModel {


    public Number0SendModel(SerialPortUtils serialPort, int keyIntent) {
    ...
    String getKeyRepeatContent() {
        return "7F 09 99 A2 B3 C4 02 FF 15 40 20 CF";
    }
