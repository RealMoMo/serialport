...
public class SerialPortSerialNumberShow extends SerialPortModel {

    public static final String CONTROLLING_CODE = "7F 08 99 A2 B3 C4 02 FF 01 86 CF";

    protected String returnCode = "7F 08 99 A2 B3 C4 02 FF 01 86 01 CF";
