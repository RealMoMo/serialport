 ...
 * @describe
 */
public class LeftSendModel extends BaseKeyEventSendModel {


    public LeftSendModel(SerialPortUtils serialPort, int keyIntent) {
    ...
    String getKeyRepeatContent() {
        return "7F 09 99 A2 B3 C4 02 FF 15 05 20 CF";
    }
