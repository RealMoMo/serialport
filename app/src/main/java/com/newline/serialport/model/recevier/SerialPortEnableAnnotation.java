...
public class SerialPortEnableAnnotation extends SerialPortModel {

    public static final String CONTROLLING_CODE = "7F 08 99 A2 B3 C4 02 FF 01 40 CF";

    protected String returnCode = "7F 09 99 A2 B3 C4 02 FF 01 40 01 CF";
    ...
    public void action(Context context) {
        ...
        if (SystemUtils.isPkgInstalled(context, packageName)) {
            StartActivityManager.startTWAnnotation(context);
        } else {
            Sender.sendStartAnnotation(context);
        }
    }
}
