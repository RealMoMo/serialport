 ...
 * @describe
 */
public class UpSendModel extends BaseKeyEventSendModel {


    public UpSendModel(SerialPortUtils serialPort, int keyIntent) {
    ...
    String getKeyDownContent() {
        return "7F 09 99 A2 B3 C4 02 FF 15 04 01 CF";
    }

    @Override
    String getKeyRepeatContent() {
        return "7F 09 99 A2 B3 C4 02 FF 15 04 20 CF";
    }
