...
import com.newline.simple.chip.UniteImpl;
import com.newline.simple.utils.DataUtils;
import com.newline.simple.chip.UniteImpl;
import com.newline.simple.utils.DataUtils;
...
//    public ChangeTool changeTool = new ChangeTool();
    ...
    public SerialPort openSerialPort(){
        try {
            serialPort = new SerialPort(new File(UniteImpl.isLangGuo() ? UniteImpl.PATH_SP :path),baudrate,0);
